...
const FileComplaint = () => {
    console.log("Inside FileComplaint()..")
    ...
    return (
        <div>
            <Navbar />
            <div className="min-w-screen h-screen flex items-center justify-center mt-9">
                <div className="bg-gray-100 text-gray-500 shadow-xl w-full overflow-hidden">
                    <div className="md:flex w-full h-full">
                        {/* Lottie Animation Section with Heading */}
                        <div className="hidden md:block w-1/2 py-10 px-10 flex flex-col justify-center items-center">
                            <h2 className="ml-40 text-3xl font-bold text-indigo-500 mb-4">File a Complaint</h2>
